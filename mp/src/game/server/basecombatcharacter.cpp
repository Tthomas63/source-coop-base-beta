...
bool CBaseCombatCharacter::HasLargeAlienGibs( void )
{
#if defined( HL2_DLL )
	Class_T myClass = Classify();
...
bool CBaseCombatCharacter::HasSmallAlienGibs(void)
{
#if defined( HL2_DLL )
	Class_T myClass = Classify();
	if (myClass == CLASS_HEADCRAB)
	{
		return true;
	}
...
void CBaseCombatCharacter::Precache()
{
	...
	PrecacheModel("models/gibs/humans/brain_gib.mdl"); // Da Brain
	PrecacheModel("models/gibs/humans/eye_gib.mdl"); // Da Eye
	PrecacheModel("models/gibs/humans/eye_gib.mdl"); // Da Eye
	PrecacheModel("models/gibs/humans/heart_gib.mdl"); // Da Heart
	PrecacheModel("models/gibs/humans/liver_gib.mdl"); // Da Liver
	PrecacheModel("models/gibs/humans/lung_gib.mdl"); // Da Lung
	PrecacheModel("models/gibs/humans/lung_gib.mdl"); // Da Lung
	PrecacheModel("models/gibs/humans/mgib_01.mdl"); //
	PrecacheModel("models/gibs/humans/mgib_02.mdl"); //
	PrecacheModel("models/gibs/humans/mgib_03.mdl"); //
	PrecacheModel("models/gibs/humans/mgib_04.mdl"); //
	PrecacheModel("models/gibs/humans/mgib_05.mdl"); //
	PrecacheModel("models/gibs/humans/mgib_06.mdl"); //
	PrecacheModel("models/gibs/humans/mgib_07.mdl"); //
	PrecacheModel("models/gibs/humans/sgib_01.mdl"); //
	PrecacheModel("models/gibs/humans/sgib_02.mdl"); //
	PrecacheModel("models/gibs/humans/sgib_03.mdl"); //
...
// There are a lot of fun things to mess with here... Will be visiting this a lot.
...
bool CBaseCombatCharacter::CorpseGib( const CTakeDamageInfo &info )
{
	...
	if ( HasHumanGibs() )
	{
		...
		CGib::CustomSpawnSpecificGibs(this, 1, minGibForce, maxGibForce, "models/gibs/humans/brain_gib.mdl", 15, m_bloodColor); // Da Brain
		CGib::CustomSpawnSpecificGibs(this, 1, minGibForce, maxGibForce, "models/gibs/humans/eye_gib.mdl", 15, m_bloodColor); // Da Eye
		CGib::CustomSpawnSpecificGibs(this, 1, minGibForce, maxGibForce, "models/gibs/humans/eye_gib.mdl", 15, m_bloodColor); // Da Eye
		CGib::CustomSpawnSpecificGibs(this, 1, minGibForce, maxGibForce, "models/gibs/humans/heart_gib.mdl", 15, m_bloodColor); // Da Heart
		CGib::CustomSpawnSpecificGibs(this, 1, minGibForce, maxGibForce, "models/gibs/humans/liver_gib.mdl", 15, m_bloodColor); // Da Liver
		CGib::CustomSpawnSpecificGibs(this, 1, minGibForce, maxGibForce, "models/gibs/humans/lung_gib.mdl", 15, m_bloodColor); // Da Lung
		CGib::CustomSpawnSpecificGibs(this, 1, minGibForce, maxGibForce, "models/gibs/humans/lung_gib.mdl", 15, m_bloodColor); // Da Lung
		CGib::CustomSpawnSpecificGibs(this, 1, minGibForce, maxGibForce, "models/gibs/humans/mgib_01.mdl", 15, m_bloodColor); //
		CGib::CustomSpawnSpecificGibs(this, 1, minGibForce, maxGibForce, "models/gibs/humans/mgib_02.mdl", 15, m_bloodColor); //
		CGib::CustomSpawnSpecificGibs(this, 1, minGibForce, maxGibForce, "models/gibs/humans/mgib_03.mdl", 15, m_bloodColor); //
		CGib::CustomSpawnSpecificGibs(this, 1, minGibForce, maxGibForce, "models/gibs/humans/mgib_04.mdl", 15, m_bloodColor); //
		CGib::CustomSpawnSpecificGibs(this, 1, minGibForce, maxGibForce, "models/gibs/humans/mgib_05.mdl", 15, m_bloodColor); //
		CGib::CustomSpawnSpecificGibs(this, 1, minGibForce, maxGibForce, "models/gibs/humans/mgib_06.mdl", 15, m_bloodColor); //
		CGib::CustomSpawnSpecificGibs(this, 1, minGibForce, maxGibForce, "models/gibs/humans/mgib_07.mdl", 15, m_bloodColor); //
		CGib::CustomSpawnSpecificGibs(this, 1, minGibForce, maxGibForce, "models/gibs/humans/sgib_01.mdl", 15, m_bloodColor); //
		CGib::CustomSpawnSpecificGibs(this, 1, minGibForce, maxGibForce, "models/gibs/humans/sgib_02.mdl", 15, m_bloodColor); //
		CGib::CustomSpawnSpecificGibs(this, 1, minGibForce, maxGibForce, "models/gibs/humans/sgib_03.mdl", 15, m_bloodColor); //
...
void CBaseCombatCharacter::Event_Killed( const CTakeDamageInfo &info )
{
	...
	if (info.GetDamage() >= (m_iMaxHealth * 0.75f))
	{
		bool bGibbed = Event_Gibbed(info);
		Msg("We should gib, and event bGibbed fired: %i?\n", bGibbed);
