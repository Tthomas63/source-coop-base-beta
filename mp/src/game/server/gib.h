...
#define	HUMAN_GIB_COUNT			62
#define ALIEN_GIB_COUNT			42
...
public:
	...
	static	void CustomSpawnSpecificGibs(CBaseEntity *pVictim, int nNumGibs, float fMaxVelocity, float fMinVelocity, const char* cModelName, float flLifetime = 25, int nCustomBloodColor = BLOOD_COLOR_YELLOW);
