...
//-----------------------------------------------------------------------------
// Purpose: Draw A Hitmarker
//-----------------------------------------------------------------------------
void CBaseCombatWeapon::DrawHitmarker(void)
{
...
BEGIN_NETWORK_TABLE(CBaseCombatWeapon, DT_BaseCombatWeapon)
	...
	SendPropBool(SENDINFO(m_bIsIronsighted)), // Ironsight
	SendPropFloat(SENDINFO(m_flIronsightedTime)), // Ironsight
#else
	...
	RecvPropFloat(RECVINFO(m_flIronsightedTime)), // Ironsight
#endif
END_NETWORK_TABLE()
